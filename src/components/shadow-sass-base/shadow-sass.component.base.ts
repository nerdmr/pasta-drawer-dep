...
export class ShadowCssComponentBase extends HTMLElement {
    ...
    constructor(css: { default: string }, useShadowDom: boolean = true) {
        ...
        if (useShadowDom) {
            ...
            shadowRoot.innerHTML = `<style>${css.default} ${cssDefault.default}</style><div class="component__wrapper"><div class="component"></div></div>`;
            ...
            this.innerHTML = `<style>${css.default} ${cssDefault.default}</style><div class="component__wrapper"><div class="component"></div></div>`;
...
export class ShadowCssComponentBaseWithLoader extends ShadowCssComponentBase {
     ...
     */
    constructor(css: { default: string }, useShadowDom: boolean = true) {
        super(css, useShadowDom);

        this.loaderElement = new CabinetLoaderComponent();
        this.componentWrapper.appendChild(this.loaderElement);
    }
